...
namespace Tests
{
    ...
    public class PlainStateMachineFake<TState, TTrigger> : IStartableStateMachine<TState, TTrigger>, IUpdatableStateMachine<TState, TTrigger>,
            IEventDispatcherStateMachine<TState, TTrigger>, IGuardedStateMachine<TState, TTrigger>
    {
        ...
        public PlainStateMachineFake(IEqualityComparer<TState> stateComparer, IEqualityComparer<TTrigger> triggerComparer)
        {
        ...
        public PlainStateMachineFake() : this(EqualityComparer<TState>.Default, EqualityComparer<TTrigger>.Default)
        {
        ...
        public void SetInitialState(TState initialState)
        {
            ...
            InitialState = initialState.ToMaybe();
        }
        ...
        {
            if (ContainsState(InitialState.Value) == false)
